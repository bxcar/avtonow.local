            ...
            <div class="catalog-content">
                ...
                <div class="catalog-content__tile">
                    ...
                    <div class="catalog-content__tile-desc">
                        <h2 class="catalog-content__tile-desc-title">Аренда Мерседес V класс чёрный</h2>
                        <div class="catalog-content__tile-desc-items">
                        <span class="catalog-content__tile-desc-item">Стоимость<!--
                    --><span class="catalog-content__tile-desc-item-inner"> 1500 руб/час</span></span>
                            <span class="catalog-content__tile-desc-item catalog-content__tile-desc-item--desktop">Трансфер в аэропорт<!--
                    --><span class="catalog-content__tile-desc-item-inner"> 7000 рублей</span></span>
                            <span class="catalog-content__tile-desc-item catalog-content__tile-desc-item--desktop">Год выпуска<!--
                    --><span class="catalog-content__tile-desc-item-inner"> 2014</span></span>
                            <span class="catalog-content__tile-desc-item catalog-content__tile-desc-item--desktop">Цвет<!--
                    --><span class="catalog-content__tile-desc-item-inner"> черный, салон кожа</span></span>
                        </div>
                        <div class="catalog-content__tile-desc-buttons">
                            <a class="catalog-content__tile-desc-button catalog-content__tile-desc-button--1" href="#">Оставить заявку</a>
                            <a class="catalog-content__tile-desc-button catalog-content__tile-desc-button--2" href="#">Подробнее</a>
                        </div>
                    </div>
                </div>
                <div class="catalog-content__tile">
                ...
                <div class="catalog-content__pagination pagination">
                    <a class="pagination__current" href="#">1</a>
                    <span class="pagination__separator">|</span>
                    <a class="pagination__inactive" href="#">2</a>
                    <span class="pagination__separator">|</span>
                    <a class="pagination__inactive" href="#">3</a>
                    <span class="pagination__separator">|</span>
                    <a class="pagination__forward" href="#">вперед >></a>
                    <a class="pagination__show-all" href="#">показать все</a>
                </div>
            </div>
        </div>
    </main>
